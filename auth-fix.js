...
function render(){style();const root=q('.biicode-welcome');if(!root)return;const inner=root.querySelector('.biicode-welcome-inner')||root;if(inner.dataset.controller==='13')return;inner.dataset.controller='13';inner.innerHTML='<div class="biicode-welcome-photo"><img class="biicode-welcome-art" src="./assets/biicode-welcome-final.webp?v=20260918d" alt="BIICODE community"><div class="biicode-welcome-tap" role="group" aria-label="Azioni BIICODE"></div></div>';const tap=inner.querySelector('.biicode-welcome-tap');
