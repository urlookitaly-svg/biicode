...
.biicode-welcome-hit{position:absolute!important;left:4%!important;width:92%!important;z-index:10002!important;border:0!important;background:transparent!important;color:transparent!important;padding:0!important;margin:0!important;-webkit-appearance:none!important;appearance:none!important;touch-action:manipulation!important}
.biicode-welcome-hit-info{top:71.5%!important;height:6.5%!important}
.biicode-welcome-hit-register{top:79%!important;height:6.5%!important}
.biicode-welcome-hit-login{top:86%!important;height:7%!important}
...
function render(){style();const root=ensureWelcome();if(!root)return;const inner=root.querySelector('.biicode-welcome-inner')||root;if(inner.dataset.controller==='16')return;inner.dataset.controller='16';inner.innerHTML='<div class="biicode-welcome-photo"><img class="biicode-welcome-art" src="./assets/biicode-welcome-final.webp?v=20260918d" alt="BIICODE community"><button class="biicode-welcome-hit biicode-welcome-hit-info" type="button" aria-label="Come funziona BIICODE"></button><button class="biicode-welcome-hit biicode-welcome-hit-register" type="button" aria-label="Registra la mia bici"></button><button class="biicode-welcome-hit biicode-welcome-hit-login" type="button" aria-label="Accedi"></button></div>';
