...
function info(){q('#biicode-network-overlay')?.remove();const o=document.createElement('div');o.id='biicode-network-overlay';o.className='biicode-network-overlay';o.innerHTML='<button class="biicode-network-close" type="button">×</button><div class="biicode-network-page"><img class="biicode-network-image" src="./assets/E8A7ED22-EC81-474A-9B2D-9BEE2CEECA62.png?v=31" alt="Come funziona BIICODE"></div>';document.body.appendChild(o);o.querySelector('button').onclick=()=>o.remove()}
...
function render(){style();const root=ensureWelcome();if(!root)return;const inner=root.querySelector('.biicode-welcome-inner')||root;if(inner.dataset.controller==='21')return;inner.dataset.controller='21';inner.innerHTML='<div class="biicode-welcome-photo"><img class="biicode-welcome-art" src="./assets/biicode-welcome-final.webp?v=20260918d" alt="BIICODE community"></div><div class="biicode-real-cta"><button class="biicode-info-btn" type="button">COME FUNZIONA? <span style="float:right;font-size:28px">›</span></button><div class="biicode-cta-row"><button class="biicode-register-btn" type="button">＋ REGISTRA</button><button class="biicode-login-btn" type="button">♙ ACCEDI</button></div></div>';
