/* BIICODE HOME V14 — reference composition */
(function(){
'use strict';
...
.head-logo{width:min(360px,100%)!important;max-height:102px!important;object-fit:contain!important;object-position:left center!important}
.bio-home-bike{position:absolute!important;right:-10px!important;top:72px!important;width:300px!important;height:128px!important;display:block!important;pointer-events:none!important;z-index:1!important;overflow:visible!important;opacity:.42!important}
.bio-home-bike svg{width:100%!important;height:100%!important;display:block!important;filter:drop-shadow(0 0 12px rgba(21,101,255,.22))!important}
.bio-home-title{position:relative!important;z-index:3!important;margin-top:48px!important;margin-bottom:15px!important}
.statusbar{position:relative!important;z-index:4!important;margin:0 0 10px 16px!important}
...
.nav{height:106px!important}.nav .plus{position:relative!important;width:78px!important;height:78px!important;min-width:78px!important;max-width:78px!important;flex:0 0 78px!important;margin-top:-22px!important;border-radius:50%!important;background:linear-gradient(145deg,#1677ff,#0755e8)!important;border:3px solid #07101b!important;box-shadow:0 0 0 2px #1677ff,0 8px 30px rgba(21,101,255,.55)!important;font-size:0!important;color:transparent!important}.nav .plus::before{content:'+';display:block!important;color:#fff!important;font-size:40px!important;font-weight:400!important;line-height:72px!important;text-align:center!important}
@media(max-width:380px){main{padding-left:14px!important;padding-right:14px!important}.head-logo{width:100%!important;max-height:96px!important}.bio-home-bike{right:-8px!important;top:68px!important;width:265px!important;height:112px!important;opacity:.38!important}.bio-home-title{margin-top:42px!important}.statusbar{margin-left:16px!important;margin-bottom:8px!important}.quick-action{min-height:88px!important;padding:12px!important}.quick-action strong{font-size:14px!important}.nav{height:104px!important}.nav .plus{width:68px!important;height:68px!important;min-width:68px!important;max-width:68px!important;flex-basis:68px!important;margin-top:-18px!important}.nav .plus::before{font-size:36px!important;line-height:62px!important}}
`;
