/* BIICODE HOME V12 — reference composition: neutral figurative bicycle */
(function(){
'use strict';
const style=document.createElement('style');
style.textContent=`
main{position:relative!important;overflow:visible!important}
.head{position:relative!important;z-index:3!important;margin-bottom:8px!important}
...
.bio-home-bike{position:absolute!important;right:-12px!important;top:105px!important;width:300px!important;height:125px!important;display:block!important;pointer-events:none!important;z-index:1!important;overflow:visible!important;opacity:.58!important}
...
.bio-home-title{position:relative!important;z-index:3!important;margin-top:78px!important;margin-bottom:15px!important}
.statusbar{position:relative!important;z-index:3!important}
...
.quick-action strong{display:block!important;font-size:15px!important;line-height:18px!important}
.quick-action span{display:block!important;color:#91a5bd!important;font-size:11px!important;line-height:15px!important;margin-top:3px!important}
.card{border-radius:21px!important;margin-bottom:11px!important}
.bike{min-height:96px!important}
.grid{margin-top:12px!important;gap:11px!important}
.action{min-height:108px!important;border-radius:19px!important}
.nav{height:106px!important}
.plus{width:72px!important;height:72px!important;min-width:72px!important;max-width:72px!important}
@media(max-width:380px){main{padding-left:14px!important;padding-right:14px!important}.head-logo{width:100%!important;max-height:104px!important}.bio-home-bike{right:-12px!important;top:102px!important;width:255px!important;height:108px!important;opacity:.5!important}.bio-home-title{margin-top:70px!important}.quick-action{min-height:88px!important;padding:12px!important}.quick-action strong{font-size:14px!important}.nav{height:104px!important}.plus{width:66px!important;height:66px!important;min-width:66px!important;max-width:66px!important}}
`;
...
function arrange(){
 ...
 const title=main.querySelector('h1');const head=main.querySelector('.head');
 ...
 if(q){const target=firstBike||grid;if(target&&q!==target)target.parentNode.insertBefore(q,target)}
}
arrange();
